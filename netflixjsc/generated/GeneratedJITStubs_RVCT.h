...
extern "C" EncodedJSValue JITStubThunked_op_get_by_id_method_check_update(STUB_ARGS_DECLARATION);
__asm EncodedJSValue cti_op_get_by_id_method_check_update(STUB_ARGS_DECLARATION)
{
    PRESERVE8
    IMPORT JITStubThunked_op_get_by_id_method_check_update
    str lr, [sp, # THUNK_RETURN_ADDRESS_OFFSET]
    bl JITStubThunked_op_get_by_id_method_check_update
    ldr lr, [sp, # THUNK_RETURN_ADDRESS_OFFSET]
    bx lr
}
