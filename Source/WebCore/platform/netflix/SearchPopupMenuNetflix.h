...
#ifndef SearchPopupMenuNetflix_h
#define SearchPopupMenuNetflix_h
...
class SearchPopupMenuNetflix : public SearchPopupMenu {
public:
    SearchPopupMenuNetflix(PopupMenuClient*);
...
private:
    RefPtr<PopupMenuNetflix> m_popup;
};

}

#endif // SearchPopupMenuNetflix_h
